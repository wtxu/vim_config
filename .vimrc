...
let g:vimrc_author='xuwentao'
let g:vimrc_email='wtxu_bj@hbgk.net'
...
"     ctag operation
""""""""""""""""""""""
nmap <C-\>m :!ctags -R --c++-kinds=+p --c-kinds=+p --fields=+iaS --extra=+q .<CR>
nmap <C-\>n :!cscope -Rbq<CR>
set tags=tags
set tags+=./tags
